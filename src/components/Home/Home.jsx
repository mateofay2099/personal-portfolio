    ...
    <section className="home" style={{ backgroundImage: `url(${homeBackground})` }}>
      ...
      <div className="homeIntroductionDiv">
        <p>
          ...
          already learned the basics of programming in a self-taught way. I love what I do and I am constantly looking
          for learning new technologies and improving my current skills.
        </p>
      </div>
